#!/usr/bin/env python3
"""
Research Engine Integration Test for JUTEQ

This test validates the research engine agents (CompanyResearcher, InterviewerResearcher, 
RoleResearcher) by making real Tavily API calls to research JUTEQ company and 
Rakesh Gohel interviewer, then formats the results in a comprehensive report.

Location: tests/test_agents/test_research_engine_integration.py
Purpose: Integration testing of research engine with live API calls
...
sys.path.append('../..')  # For relative imports from tests/test_agents folder
