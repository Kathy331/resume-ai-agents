...
class InterviewPrepWorkflow:
    ...
    def __init__(self):
        ...
        self.prep_guide_pipeline = EnhancedPersonalizedPrepGuidePipeline()
        
        # Use the same enhanced pipeline for both basic and enhanced
        self.enhanced_prep_guide_pipeline = self.prep_guide_pipeline
        ...
        print("   📚 Enhanced Personalized Prep Guide Pipeline (Highly Personalized + Citations)")
