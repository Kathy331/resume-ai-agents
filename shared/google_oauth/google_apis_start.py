...
def create_service(client_secret_file, api_name, api_version, *scopes, prefix=''):
    CLIENT_SECRET_FILE = client_secret_file # the client_secret.json file
    API_SERVICE_NAME = api_name # the name of the API service... 'gmail'
    API_VERSION = api_version 
    SCOPES = [scope for scope in scopes[0]] # level of access you need
